      ...
      ws.onmessage = (ev) => {
        ...
        try {
          ...
          const frame: TelemetryFrame = {
            ...
            speed:        r(d.speed),
            fuel_level:   r(d.fuel_level),
            fuel_rate:    r(d.fuel_consumption),
            engine_temp:  r(d.engine_temp),
            oil_pressure: +d.oil_pressure.toFixed(1),
            rpm:          r(d.engine_rpm),
            traction:     r(d.traction_force),
            voltage:      r(d.traction_voltage),
            current:      r(d.traction_current),
            health_score: r(score),
            health_status: status,
            alerts: mapAlerts(msg.alerts),
            gps_lat: d.gps_lat,
            gps_lon: d.gps_lon,
            wheel_slip:              +d.wheel_slip.toFixed(2),
            oil_temp:                r(d.oil_temp),
            pantograph_voltage:      r(d.pantograph_voltage),
            inverter_temp:           r(d.inverter_temp),
            battery_voltage:         +d.battery_voltage.toFixed(1),
            brake_pipe_pressure:     +d.brake_pipe_pressure.toFixed(1),
            brake_cylinder_pressure: +d.brake_cylinder_pressure.toFixed(1),
            main_reservoir_pressure: +d.main_reservoir_pressure.toFixed(1),
            ambient_temp:            r(d.ambient_temp),
          };
